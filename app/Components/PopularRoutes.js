      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative group/carousel px-2 py-6">
          ...
          <button
            ...
            className="absolute -left-3 md:-left-5 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full bg-[#7c3aed] hover:bg-[#6D28D9] text-white flex items-center justify-center shadow-lg shadow-purple-600/30 transition-all hover:scale-110 active:scale-95 border-2 border-white"
          >
          ...
          <button
            ...
            className="absolute -right-3 md:-right-5 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full bg-[#7c3aed] hover:bg-[#6D28D9] text-white flex items-center justify-center shadow-lg shadow-purple-600/30 transition-all hover:scale-110 active:scale-95 border-2 border-white"
          >
