    ...
    <section className="w-full bg-[#f8fafc] py-16 px-4 md:px-8 relative overflow-hidden font-sans">
      ...
      <style jsx global>{`
        ...
        .btn-3d-amber {
          ...
          font-size: 12px;
          box-shadow: 
            0px 6px 8px rgba(254, 240, 138, 0.6) inset,
            0px 3px 6px rgba(5, 5, 5, 0.25),
            0px -6px 8px rgba(217, 119, 6, 0.9) inset;
          cursor: pointer;
          display: flex;
          align-items: center;
              ...
              <div key={item.id} className="flip-card group cursor-pointer">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back rounded-xl">
                    ...
                    {/* 3D Jello Button */}
                    <button type="button" className="btn-3d-amber">
